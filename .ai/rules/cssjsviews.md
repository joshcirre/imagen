...
## Use approved Imagen brand systems

Imagen artwork must use the Laravel Cloud blue grid or Laravel open-source red grid as its approved programmatic background. Use Instrument Sans for editor UI and exported artwork. User-supplied backgrounds should remain under the selected brand grid treatment.
